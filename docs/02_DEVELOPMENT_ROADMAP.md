...
### NEXT — Wave B4: structured task/checklist generation

Turn rich studio intake (text, grouped messages, screenshots, PDFs) into a structured task/checklist proposal, preserving source context and requiring explicit user intent before any verified Trello write.
