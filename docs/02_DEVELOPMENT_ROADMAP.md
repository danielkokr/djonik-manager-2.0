...
### NEXT — Wave B2: PDF/file intake

Telegram PDF/file → Claude-native supported file input → understanding/interpretation → optional safe task generation, preserving source context.

This is NEXT only, not NOW, until a bounded GitHub issue is explicitly created.
