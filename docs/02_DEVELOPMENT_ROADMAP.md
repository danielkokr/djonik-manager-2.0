...
### NEXT — Wave B5: source-preserving context

Preserve useful provenance from rich studio intake so Djonik can retain where actionable facts came from (for example Telegram text, screenshot/image, PDF, grouped intake) without dumping raw source material, inventing authority, or creating a duplicate transcript/storage system.
