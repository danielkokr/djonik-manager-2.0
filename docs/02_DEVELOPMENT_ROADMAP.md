...
### NEXT — Wave C: Project health and reviews

Prepare the next bounded capability slice around evidence-based project health/review behavior: a `project-health` Skill, stale/blocked/risk judgement grounded in fresh Trello evidence, and meaningful follow-up lifecycle. Do not mark Wave C NOW until a bounded GitHub issue is explicitly created.
