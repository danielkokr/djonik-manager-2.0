...
### NOW — Wave B5: Preserve source context across rich studio intake (#27)

Preserve useful provenance and native cross-modal ordering from rich Telegram intake so Djonik can distinguish Daniel's instructions/corrections from screenshot/PDF/reference facts, carry concise source context into structured work when useful, and avoid raw-source duplication or a new transcript/storage system.
