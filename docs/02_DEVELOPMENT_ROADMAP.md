...
### NOW — Wave B3: Group related Telegram messages into one coherent intake (#25)

Multiple related Telegram fragments → preserve order/relationship → one coherent Managed Agent intake → avoid duplicate/fragmented requests.
