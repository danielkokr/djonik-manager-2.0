...
### NEXT — Wave B3: grouped related Telegram messages

Multiple related Telegram messages/media sent close together → preserve their relationship/context → one coherent Managed Agent intake → avoid treating each fragment as an unrelated request.
