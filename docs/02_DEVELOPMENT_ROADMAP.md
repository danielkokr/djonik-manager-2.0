...
### NOW — Post-write due-date wording must match verified Trello field (#23)

After a verified Trello write, exact due-date/day wording in the user-visible response must be grounded in the verified same-card field. If intended and verified values differ, Djonik must report the verified result rather than a stale/intended value.
